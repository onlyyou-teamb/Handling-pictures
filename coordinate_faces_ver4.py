...
def CoordinateFaces (main_path1, main_path2, main_path3, target_path): # gets 2pics from profile. 1 target pic(with various people)
    ...
    for i in [0,1,2]:
        for a in range(1,n_people):
            ...
            if result > face_distances[i]:
                result = face_distances[i]
                result_loc = a
    ...
    #cropped_img.save("./image/hyunjay_face3.jpg")
...
#indi_sung_jin4 = "./image/indi_sung_jin4.jpg"
...
#print(CoordinateFaces(indi_sung_jin1, indi_sung_jin2, indi_sung_jin2, lot_of_people1))
